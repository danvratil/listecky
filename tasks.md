...
1. Větu pod nadpisem (_Představím vám…_) označkuj jako odstavec.
...
1. Přidej za mapu tento text o licenci: `Autorem skenů je Paul K. pod licencí CC 2.0`.
...
/* to samé pomocí zkratky (shorthand) */
div {
